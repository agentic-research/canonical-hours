...
import type { Source } from "@agentic-research/vespers-core";

/**
 * Loads the optional private-sources module (canonical-hours-dfb779):
 * private data-source implementations don't belong in this public repo.
 * `path`, when set, points at a *built* dist/index.js exporting a
